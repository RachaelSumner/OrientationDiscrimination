% OrientationDescrimination_Oblique
...
DeviceID = []; % leave empty for default, else define for use in pahandle = PsychPortAudio('Open', DeviceID ,...).
...
pahandle = PsychPortAudio('Open', DeviceID ,[],2,48000,2); %7 is the soundcard
